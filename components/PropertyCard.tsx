...
export const PropertyCard = ({ property, index }: PropertyCardProps) => {
  ...
  const getPropertyLogo = () => {
    if (property.property_url.includes('squareyards')) {
      return require('../assets/images/squareyards-logo.png');
    } else if (property.property_url.includes('99acres')) {
      return require('../assets/images/99acres-logo.png');
    } else if (property.property_url.includes('housing')) {
      return require('../assets/images/housing-logo.png');
    }
    return null;
  };

  const logo = getPropertyLogo();
